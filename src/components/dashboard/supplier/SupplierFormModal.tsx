...
import { Supplier, SupplierDTO, isSupplier } from "@/types/supplier";
...
export default function SupplierFormModal({
  ...
  const filteredData = useMemo(() => {
    if (!data) return null;
    if (isSupplier(data)) {
      const { supplierId, createdAt, updatedAt, ...rest } = data;
      return rest;
    }
  ...
  const [formData, setFormData] = useState<SupplierDTO | null>(filteredData);
